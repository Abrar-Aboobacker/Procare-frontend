...
const LoginChangeContainer = () => {
  ...
  <Paper elevation={20} style={paperStyle}>
    ...
    <TabPanel sx={{padding:0, marginTop:"0", borderRadius:5,}} value="0">< UserLogin/></TabPanel>

    <TabPanel sx={{padding:0, marginTop:"0", borderRadius:5,}} value="1"><DoctorLogin/></TabPanel>
    </Paper>
    </TabContext>
